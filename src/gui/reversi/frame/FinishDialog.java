...
import gui.reversi.game.IReversi;
...
public class FinishDialog extends Dialog {
	...
	public FinishDialog(Dialog owner, String title, IReversi reversi, String blackPlayerName, String whitePlayerName) {
		super(owner, title);
		countAll(reversi);
		setLayout(null);
		setSize(370, 150);
	...
	private void countAll(IReversi reversi){
